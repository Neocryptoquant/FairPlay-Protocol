...
export const ASSIGN_SCORE_DISCRIMINATOR = new Uint8Array([
  228, 170, 169, 248, 127, 170, 0, 110,
]);

export function getAssignScoreDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ASSIGN_SCORE_DISCRIMINATOR
  );
}

export type AssignScoreInstruction<
...
export type AssignScoreInstructionData = {
  discriminator: ReadonlyUint8Array;
  seed: bigint;
  contributionScore: bigint;
};

export type AssignScoreInstructionDataArgs = {
  seed: number | bigint;
  contributionScore: number | bigint;
};

export function getAssignScoreInstructionDataEncoder(): FixedSizeEncoder<AssignScoreInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ASSIGN_SCORE_DISCRIMINATOR })
  );
}

export function getAssignScoreInstructionDataDecoder(): FixedSizeDecoder<AssignScoreInstructionData> {
...
export function getAssignScoreInstructionDataCodec(): FixedSizeCodec<
  AssignScoreInstructionDataArgs,
  AssignScoreInstructionData
> {
  return combineCodec(
    getAssignScoreInstructionDataEncoder(),
    getAssignScoreInstructionDataDecoder()
  );
}

export type AssignScoreAsyncInput<
...
> = {
  ...
  seed: AssignScoreInstructionDataArgs['seed'];
  contributionScore: AssignScoreInstructionDataArgs['contributionScore'];
};

export async function getAssignScoreInstructionAsync<
  TAccountSystemProgram extends string,
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSponsor extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAssignScoreInstructionDataEncoder().encode(
      args as AssignScoreInstructionDataArgs
    ),
  } as AssignScoreInstruction<
    TProgramAddress,
    TAccountSystemProgram,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
...
export function getAssignScoreInstruction<
  TAccountSystemProgram extends string,
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSponsor extends string,
...
export type ParsedAssignScoreInstruction<
  TProgram extends string = typeof FAIRPLAY_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AssignScoreInstructionData;
};

export function parseAssignScoreInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAssignScoreInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAssignScoreInstructionDataDecoder().decode(instruction.data),
  };
}
