...
// //   // Campaign variables
// //   const campaignSeed = new BN(12345);
// //   const campaignId = 1;
// //   const totalPoolAmount = new BN(1000 * 1_000_000); // 1000 USDC (6 decimals)
// //   let startTime: BN;
// //   let endTime: BN;
...
// //     endTime = new BN(now + 7 * 24 * 60 * 60); // 7 days from now
// //   });
...
// //       const depositAmount = new BN(500 * 1_000_000); // 500 USDC
...
// //             [Buffer.from("CampaignConfig"), new BN(12346).toBuffer("le", 8)],
// //             program.programId
// //           )[0],
// //           contributor: contributor2Pda,
...
// //           campaignConfig: PublicKey.findProgramAddressSync(
// //             [Buffer.from("CampaignConfig"), new BN(12347).toBuffer("le", 8)],
// //             program.programId
// //           )[0],
...
// //       const score2 = new BN(20);
// //       await program.methods
// //         .assignScore(new BN(12346), score2)
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor2.publicKey,
// //           usdcTokenMint: usdcMint,
// //           escrow: PublicKey.findProgramAddressSync(
// //             [Buffer.from("escrow"), contributor2.publicKey.toBuffer(), new BN(12346).toBuffer("le", 8)],
// //             program.programId
// //           )[0],
// //           campaignConfig: PublicKey.findProgramAddressSync(
// //             [Buffer.from("CampaignConfig"), new BN(12346).toBuffer("le", 8)],
...
// //       const score3 = new BN(0);
// //       await program.methods
// //         .assignScore(new BN(12347), score3)
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor3.publicKey,
// //           usdcTokenMint: usdcMint,
// //           escrow: PublicKey.findProgramAddressSync(
// //             [Buffer.from("escrow"), contributor3.publicKey.toBuffer(), new BN(12347).toBuffer("le", 8)],
// //             program.programId
// //           )[0],
// //           campaignConfig: PublicKey.findProgramAddressSync(
// //             [Buffer.from("CampaignConfig"), new BN(12347).toBuffer("le", 8)],
...
// //       await program.methods
// //         .scoringEngine(campaignSeed, new BN(100))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       await program.methods
// //         .scoringEngine(new BN(12346), new BN(20))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor2.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       try {
// //         await program.methods
// //           .scoringEngine(campaignSeed, new BN(150)) // Score > 100
// //           .accounts({
// //             sponsor: sponsor.publicKey,
// //             user: contributor1.publicKey,
// //             usdcTokenMint: usdcMint,
...
// //       try {
// //         await program.methods
// //           .scoringEngine(newSeed, new BN(0))
// //           .accounts({
// //             sponsor: sponsor.publicKey,
// //             user: contributor1.publicKey,
// //             usdcTokenMint: usdcMint,
...
// //       try {
// //         await program.methods
// //           .assignScore(campaignSeed, new BN(50))
// //           .accounts({
...
// //       const lifecycleSeed = new BN(88888);
...
// //       await program.methods
// //         .deposit(lifecycleSeed, new BN(500 * 1_000_000))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       await program.methods
// //         .assignScore(lifecycleSeed, new BN(75))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       await program.methods
// //         .scoringEngine(lifecycleSeed, new BN(75))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       assert.isTrue(finalContributorState.rewardShare.gt(new BN(0)));
...
// //       const performanceSeed = new BN(77777);
...
// //       await program.methods
// //         .deposit(performanceSeed, new BN(100 * 1_000_000))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       await program.methods
// //         .assignScore(performanceSeed, new BN(50))
// //         .accounts({
// //           sponsor: sponsor.publicKey,
// //           user: contributor1.publicKey,
// //           usdcTokenMint: usdcMint,
...
// //       const poolAmount = new BN(1000 * 1_000_000); // 1000 USDC
// //       let totalExpectedScore = 0;
// //       const rewards = [];

// //       for (let i = 0; i < contributors.length; i++) {
// //         const contributor = contributors[i];
// //         const contributorSeed = new BN(multiSeed.toNumber() + i);
...
// //         // Assign score
// //         await program.methods
// //           .assignScore(contributorSeed, new BN(contributor.score))
// //           .accounts({
// //             sponsor: sponsor.publicKey,
// //             user: contributor.keypair.publicKey,
// //             usdcTokenMint: usdcMint,
...
// //         // Run scoring engine
// //         await program.methods
// //           .scoringEngine(contributorSeed, new BN(contributor.score))
// //           .accounts({
// //             sponsor: sponsor.publicKey,
// //             user: contributor.keypair.publicKey,
// //             usdcTokenMint: usdcMint,
...
// //         const expectedReward = new BN(contributor.score)
// //           .mul(poolAmount)
// //           .div(new BN(totalExpectedScore));
...
// //         const tolerance = new BN(1000); // 0.001 USDC tolerance
...
// //         const contributorSeed = new BN(stressSeed.toNumber() + i);
...
// //           await program.methods
// //             .assignScore(contributorSeed, new BN(score))
// //             .accounts({
// //               sponsor: sponsor.publicKey,
// //               user: testContributor.publicKey,
// //               usdcTokenMint: usdcMint,
